...
{
    class EditOpeningClosingDocHeaderViewModel:BindableBase
    {
        #region Constructors
        public EditOpeningClosingDocHeaderViewModel(IAccDocumentHeadersService accDocumentHeadersService, IAppContextService appContextService, Saina.Data.Context.SainaDbContext uow)
        {
